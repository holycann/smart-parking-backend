...
func (s *Store) GetAllTransaction() (transaction []*Transaction, err error) {
...
func (s *Store) GetTransactionByReservationID(ReservationID int) (*Transaction, error) {
...
func (s *Store) GetTransactionByID(id int) (*Transaction, error) {
...
func (s *Store) CreateTransaction(transaction *CreateTransactionPayload) error {
...
func (s *Store) UpdateTransaction(transaction *UpdateTransactionPayload) error {
