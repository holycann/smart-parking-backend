...
func (s *Store) GetAllVehicle() (vehicles []*Vehicle, err error) {
...
func (s *Store) GetVehicleByPlate(plate string) (*Vehicle, error) {
...
func (s *Store) GetVehicleByID(id int) (*Vehicle, error) {
...
func (s *Store) CreateVehicle(vehicle *CreateVehiclePayload) error {
...
func (s *Store) UpdateVehicle(vehicle *UpdateVehiclePayload) error {
